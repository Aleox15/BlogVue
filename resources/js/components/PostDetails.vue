    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <p>Posted on <strong class="badge badge-primary p-1">{{post.added_at}}</strong>
            <span class="float-right"><strong class="badge badge-info p-1">{{post.comment_count}}</strong> comments</span></p>
        ...
        <!-- Single Comment -->
        <div v-for="(comment,index) in post.comments" :key="index" class="media mb-4">
